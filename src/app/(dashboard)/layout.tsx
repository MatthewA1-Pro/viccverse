  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top Navbar */}
        <header className="h-16 border-b border-white/5 bg-slate-950 sticky top-0 z-40 flex items-center justify-between px-4 lg:px-6 shadow-[0_4px_20px_rgba(0,0,0,0.6)]">
